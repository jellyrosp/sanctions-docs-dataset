...
html_path = "sanctions/UN_EU/DPRK/Consolidated_TEXT_ 32017R1509_13.09.2024/Consolidated_TEXT_ 32017R1509_13.09.2024_CLEANED.html"
...
def extract_UN_EU_DPRK_data():
    ...
    for table in tables:
        ...
        for row in rows:
            ...
            # --- Reason ---
            reason_texts = []
            for reason_tag in cols[5].find_all("p", class_="tbl-norm"):
            ...
            # --- Date ---
            date_tag = cols[4].find("p", class_="tbl-left")
            if date_tag:
